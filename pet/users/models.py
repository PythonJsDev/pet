...
class User(AbstractUser):
    ...
    address1 = models.CharField(verbose_name=_("Address line 1"), max_length=1024, blank=True)
    address2 = models.CharField(verbose_name=_("Address line 2"), max_length=1024, blank=True)
    zip_code = models.CharField(verbose_name=_("Postal Code"), max_length=12, blank=True)
    city = models.CharField(verbose_name=_("City"), max_length=1024, blank=True)
    ...
    photo = models.ImageField(verbose_name=_("Photo"), upload_to='photos/', default='photos/avatar-user-64.png')
